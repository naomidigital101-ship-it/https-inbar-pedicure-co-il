export function InArticleCTA() {
  return (
    <aside className="my-12 border border-[#d6c5ac] bg-[#fefaf6] p-8 md:p-10">
      <div className="mb-3 text-[10px] font-black uppercase tracking-widest text-[#8b3a52]">
        [ MOD: PRO // GARAGE ]
      </div>
      <h3 className="mb-3 text-2xl font-black leading-tight text-[#2a1f1a] md:text-3xl">
      ...
      <a
        href="#lead-magnet"
        className="inline-flex items-center gap-3 bg-[#8b3a52] px-6 py-3 text-sm font-black uppercase tracking-wider text-[#fefaf6] transition-colors hover:bg-[#ff3a00]"
      >
        הורד עכשיו
