...
export function LeadMagnet() {
  ...
  return (
    <section
      id="lead-magnet"
      className="flex flex-col items-start justify-between gap-8 border-t border-[#0a0a0a] bg-[#e63000] p-8 md:flex-row md:items-center md:p-12"
    >
      <div>
      ...
      >
        <div className="flex w-full">
          <input
            ...
            maxLength={255}
            className="w-full border-2 border-transparent bg-[#0a0a0a] px-6 py-4 font-bold text-white placeholder:text-[#a0a0a0] focus:outline-none focus-visible:border-white focus-visible:ring-2 focus-visible:ring-white disabled:opacity-60 md:w-80"
          />
          <button
            type="submit"
            disabled={isLoading}
            className="whitespace-nowrap bg-white px-8 py-4 font-black uppercase text-[#e63000] transition-colors hover:bg-[#f0f0f0] disabled:cursor-not-allowed disabled:opacity-60"
          >
