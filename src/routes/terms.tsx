...
const sections: { title: string; body: string[] }[] = [
  {
    ...
    body: [
      ...
      "האתר מספק מידע על הקליניקה, שירותי הפדיקור הטיפולי, מדריכים וכלי תיאום פגישות. המידע מיועד לציבור הרחב בישראל ואינו מהווה ייעוץ רפואי פרטני.",
    ],
  },
  {
    title: "2. אופי הטיפול והגבלת אחריות",
    body: [
      "פדיקור טיפולי הוא טיפול קוסמטי־טיפולי בכף הרגל, ואינו מהווה תחליף לאבחון או טיפול רפואי. במקרים של פצע פתוח, חשד לזיהום, סוכרת לא מאוזנת, מחלות כלי דם או כל סימן אזהרה אחר — יש לפנות לרופא לפני הטיפול.",
      "התכנים, המאמרים והמדריכים באתר נכתבים על בסיס ניסיון קליני ופרוטוקולים מקצועיים (איכילוב, אגודת אייל), אך הם בעלי אופי הסברתי בלבד ואינם תחליף לבדיקה אישית בקליניקה או לייעוץ רפואי.",
