...
const sections: { title: string; body: string[] }[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "התכנים, המאמרים והמדריכים באתר נכתבים על בסיס ניסיון קליני ופרוטוקולים מקצועיים (איכילוב, IWGDF, NHS), אך הם בעלי אופי הסברתי בלבד ואינם תחליף לבדיקה אישית בקליניקה או לייעוץ רפואי.",
