...
const FAQS = [
  ...
  { q: "ניסיתי טיפולים בעבר ולא היה שיפור, איך אדע שהפעם זה יעזור?", a: "ההבדל הוא בגישה. אני לא מטפלת רק בסימפטום אלא במקור הבעיה. כל טיפול נבנה לפי מצב העור, הציפורניים וההיסטוריה הרפואית שלך, עם שילוב של ידע קליני, ניסיון, שיטות מתקדמות כמו BIO והדרכה ביתית." },
