...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: `קליניקה רפואית לכף הרגל בבית אל. ${SITE.brand}, פדיקוריסטית טיפולית עם 12+ שנות ניסיון. טיפול ביבלות, פטרת, ציפורן חודרנית, סדקים וסוכרת. שירות לכל אזור בנימין, ירושלים והיישובים הסמוכים.` },
      { name: "keywords", content: "פדיקור טיפולי בית אל, פדיקור רפואי אזור בנימין, פדיקור ירושלים, יבלות, פטרת בציפורן, ציפורן חודרנית, פדיקור לחולי סוכרת, ענבר פרחי" },
      ...
      { property: "og:description", content: `קליניקה רפואית לכף הרגל בבית אל. טיפול ביבלות, פטרת, ציפורן חודרנית וסוכרת. שירות לכל אזור בנימין וירושלים.` },
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          name: SITE.brand,
          description: `קליניקה רפואית לפדיקור טיפולי בבית אל, אזור בנימין. ${SITE.shortDescription}`,
          url: SITE.url,
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          image: SITE.url + inbarPhoto,
          url: SITE.url,
          worksFor: { "@type": "MedicalBusiness", name: SITE.brand },
          ...
          <div className="mx-auto max-w-[1100px] px-6">
            <div className="grid gap-10 md:grid-cols-[1fr_1.4fr] md:items-start">
              <div>
                ...
                <p className="mt-4 text-base leading-relaxed text-ink-soft">
                  פדיקור טיפולי הוא כלי חזק, אבל יש סימנים שמחייבים בדיקה רפואית מקדימה. אם את/ה מזהה אחד מאלה, אשמח להפנות לרופא המתאים לפני שנמשיך.
                </p>
              </div>
