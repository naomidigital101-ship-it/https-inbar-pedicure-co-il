    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main id="main-content" className="mx-auto max-w-[1100px] flex-1 px-6 py-16 md:px-10 md:py-20">
        ...
        <p className="mt-12 max-w-3xl" style={{ color: "var(--ink-600)", lineHeight: 1.85, fontSize: "0.98rem" }}>
          ...
          הנכון או לקבוע פגישת אבחון אישית. כל המידע באתר מבוסס על מקורות רפואיים סמכותיים בלבד –
          משרד הבריאות, APMA, NHS, אגודת אייל ו-Mayo Clinic – ולא מחליף ייעוץ רפואי פרטני.
        </p>
      </main>
      <SiteFooter />
    </div>
