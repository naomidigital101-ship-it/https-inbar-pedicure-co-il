              ...
              <dl className="space-y-5">
                {[
                  ...
                  },
                  {
                    ...
                    a: "כן, ודאי. אני מתמחה בכף רגל סוכרתית לפי קווים מנחים של IWGDF 2023, כולל בדיקת מוניטרינג סיכון שנתית, טיפול במניעת פצעים, וייעוץ לבחירת נעליים מתאימות. חשוב להזכיר את אבחנת הסוכרת בעת קביעת התור.",
                  },
                ].map((f, i) => (
