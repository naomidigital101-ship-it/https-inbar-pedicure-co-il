      ...
      <main id="main-content" className="flex-1">
        ...
        <article className="border-b border-[#222] bg-[#0a0a0a]">
          <div className="mx-auto max-w-[760px] px-4 py-14 md:px-8 md:py-20">
            ...
            <div className="mb-12 space-y-4 text-lg leading-loose text-[#d8d8d8]">
              <p>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <a
                ...
                className="group flex items-start gap-4 border border-[#222] bg-[#111] p-6 transition-colors hover:border-[#e63000]"
                aria-label="שליחת מייל לכתובת hello@dirt-road-guide.lovable.app"
              >
                <Mail className="h-6 w-6 flex-shrink-0 text-[#e63000]" aria-hidden="true" />
                <div>
                  <div className="mb-1 text-[10px] font-black uppercase tracking-widest text-[#888]">
                    דואר אלקטרוני
                  </div>
                  <div className="text-sm font-bold text-[#f0f0f0] group-hover:text-[#e63000]">
              ...
              <div className="flex items-start gap-4 border border-[#222] bg-[#111] p-6">
                <MessageCircle className="h-6 w-6 flex-shrink-0 text-[#e63000]" aria-hidden="true" />
                <div>
                  <div className="mb-1 text-[10px] font-black uppercase tracking-widest text-[#888]">
                    זמן תגובה
                  </div>
                  <div className="text-sm font-bold text-[#f0f0f0]">עד 5 ימי עסקים</div>
                  <p className="mt-2 text-xs text-[#888]">בסופי שבוע אנחנו על האופנוע</p>
                </div>
              </div>
            </div>

            <div className="mt-12 border-t border-[#222] pt-10">
              <h2 className="mb-4 text-xl font-bold text-[#f0f0f0]">לפני שכותבים</h2>
              <ul className="space-y-3 text-base leading-relaxed text-[#d8d8d8]">
                <li className="flex gap-3">
                  <span aria-hidden="true" className="mt-2 h-1.5 w-1.5 flex-shrink-0 bg-[#e63000]" />
