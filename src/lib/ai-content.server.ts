...
- "ניתוח", "כירורגיה", "מינון", "מרשם", "תרופה", "אבחנה", "אבחון" (לא בסמכותה - הפנייה לרופא במידת הצורך)
...
- "ניתוח", "כירורגי", "כירורגיה", "מינון", "מרשם", "תרופה", "אבחנה", "אבחון", "טיפול תרופתי" (לא בסמכותה - הפניה לרופא בלבד)
...
אם נושא המאמר עוסק במצב שמחייב רופא (סוכרת, פצע פתוח, זיהום מתקדם, חשד לגידול) - הפני בבירור: "זה לא משהו שמטפלים בו בקליניקה לטיפוח. צריך לפנות לרופא משפחה / רופא עור / כירורג כלי דם." אל תכתבי הוראות טיפול שמחייבות הסמכה רפואית.
...
- callouts: tip לטיפים שגרתיים, warning לסימני אזהרה שמחייבים פנייה לרופא, saving לחיסכון בזמן/כסף בטיפוח ביתי בטוח.
